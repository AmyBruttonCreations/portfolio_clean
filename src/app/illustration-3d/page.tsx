...
const projects = [
  {
    title: "3D Illustration 1",
    img: "https://via.placeholder.com/800x400?text=3D+1",
    info: "This is a description of 3D Illustration 1. Modeled and rendered in Blender.",
  },
  {
    title: "3D Illustration 2",
    img: "https://via.placeholder.com/800x400?text=3D+2",
    info: "This is a description of 3D Illustration 2. Photorealistic lighting and texturing.",
  },
  {
    title: "3D Illustration 3",
    img: "https://via.placeholder.com/800x400?text=3D+3",
    info: "This is a description of 3D Illustration 3. Stylized character sculpt.",
  },
];
...
export default function Illustration3D() {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 pb-12">
      <HamburgerMenu />
      {/* Top banner */}
      <div className="w-full">
        {topBanner}
      </div>
      <div className="w-full px-2 sm:px-0 flex flex-col items-center gap-12">
        {projects.map((project, idx) => (
          <div key={idx} className="w-full bg-white dark:bg-gray-800 shadow overflow-hidden relative flex flex-col justify-center my-8">
