...
const projects = [
  {
    title: "Cel Animation 1",
    img: "https://via.placeholder.com/800x400?text=Cel+1",
    info: "This is a description of Cel Animation 1. Frame-by-frame animation demo.",
  },
  {
    title: "Cel Animation 2",
    img: "https://via.placeholder.com/800x400?text=Cel+2",
    info: "This is a description of Cel Animation 2. Classic hand-drawn style.",
  },
  {
    title: "Cel Animation 3",
    img: "https://via.placeholder.com/800x400?text=Cel+3",
    info: "This is a description of Cel Animation 3. Dynamic character movement.",
  },
];
...
export default function CelAnimation() {
