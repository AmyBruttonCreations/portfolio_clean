          ...
          <div className="skillset-menu" style={{
            ...
            <div className="skillset-row" style={{ display: 'flex', alignItems: 'center', gap: '2.5rem', marginBottom: 0 }}>
              ...
              <Link href="/vector-art" style={{ textDecoration: 'none' }}>
                <div className="rgb-split-hover skillset-link" style={{ fontWeight: 900, fontSize: '2rem', color: '#EF1481', textTransform: 'uppercase', letterSpacing: '0.04em', transition: 'color 0.2s' }}>Vector Art</div>
              </Link>
            </div>
            <div className="skillset-row" style={{ display: 'flex', alignItems: 'center', gap: '2.5rem', marginBottom: 0 }}>
            ...
            <div className="skillset-row" style={{ display: 'flex', alignItems: 'center', gap: '2.5rem', marginBottom: 0 }}>
              ...
              <Link href="/illustration-2d" style={{ textDecoration: 'none' }}>
                <div className="rgb-split-hover skillset-link" style={{ fontWeight: 900, fontSize: '2rem', color: '#EF1481', textTransform: 'uppercase', letterSpacing: '0.04em', transition: 'color 0.2s' }}>2D and 3D Illustration</div>
              </Link>
            </div>
          </div>
        </div>
